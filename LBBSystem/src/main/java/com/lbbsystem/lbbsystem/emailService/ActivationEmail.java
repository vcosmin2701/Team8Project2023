...
public class ActivationEmail extends EmailMessage {
  ...
  public void setSubject() {
    final String subject = "Welcome to the University Library - Confirm Your Registration!";
    this.subject = subject;
  }

  public void setContent(String firstName, String lastName, String activationLink) {
    String content = "<!DOCTYPE html>"
      ...
      + "<p>We are excited to have you with us. Ready to dive into the ocean of knowledge? Your journey begins with a single click.</p>"
      + "<table style=\"width: 100%; margin: 0 auto;\">"
      + "<tr>"
      + "<td style=\"text-align: center;\">"
      + "<a href=\""+activationLink+ "\" class=\"btn\" style=\"background-color: #0056b3; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; text-align: center;\">Activate Your Account</a>"
      + "</td>"
      + "</tr>"
      + "</table>"
